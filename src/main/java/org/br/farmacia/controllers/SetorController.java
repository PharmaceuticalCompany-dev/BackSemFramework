...
public class SetorController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try {
            ...
            Setor novoSetor = new Setor(
                    input.id, // Assuming ID can be passed for creation or it will be auto-generated by DB
                    TipoSetor.valueOf(input.tipoSetor.toUpperCase()),
                    new ArrayList<>() // Initialize with an empty list of Funcionarios for creation
            );
        ...
        } catch (IllegalArgumentException e) { // Catch for invalid enum value
            resp.setStatus(HttpServletResponse.SC_BAD_REQUEST);
            JsonObject error = new JsonObject();
    ...
    protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try {
            SetorInput input = gson.fromJson(req.getReader(), SetorInput.class);
            int id = input.id; // Assuming ID is part of the input for update

            Setor setorAtualizado = new Setor(
                    id,
                    TipoSetor.valueOf(input.tipoSetor.toUpperCase()),
                    new ArrayList<>() // When updating, you might not send the full list of employees
            );
